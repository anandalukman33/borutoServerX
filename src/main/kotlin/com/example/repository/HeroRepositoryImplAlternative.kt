...
class HeroRepositoryImplAlternative: HeroRepositoryAlternative {
    ...
    override suspend fun getAllHeroes(page: Int, limit: Int): ApiResponse = ApiResponse(
        success = true,
        message = "Ok",
        prevPage = calculatePage(heroes, page, limit)["prevPage"],
        nextPage = calculatePage(heroes, page, limit)["prevPage"],
    ...
    private fun calculatePage(heroes: List<Hero>, page: Int, limit: Int): Map<String, Int?> {
        ...
        val prevPage = if (page == 1) null else page.minus(1)
